...
const Contacts = () => {
  ...
  return (
    <section id='contact' className='relative flex flex-col max-sm:justify-center sm:min-h-[103vh] max-sm:h-[103vh] md:min-h-[130vh] lg:min-h-[85vh] 2xl:min-h-[70vh] 2xl:pt-[150px] 2xl:pb-[205px] lg:pt-[100px] lg:pb-[160px] md:pt-[70px] md:pb-[130px] sm:pt-[50px] max-sm:pb-[70px] bg-black lg:pr-[110px] lg:pl-[110px] md:pr-[34px] md:pl-[34px]'>
