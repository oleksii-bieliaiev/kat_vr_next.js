...
const About = () => {
  ...
  return (
    <section id='about' className='relative flex flex-col justify-center lg:min-h-[103vh] md:min-h-[150vh] sm:h-[177vh] bg-gradient-to-r from-[#191536] to-[#000000] lg:pr-[110px] lg:pl-[110px] md:pr-[34px] md:pl-[34px] lg:pb-[130px] lg:pt-[130px] md:pb-[70px] md:pt-[70px] max-sm:pl-[34px] max-sm:pr-[34px] max-sm:pt-[50px] max-sm:pb-[50px]'>
      <div className='grid lg:grid-cols-12 md:grid-cols-6 md:gap-5 max-sm:grid-cols-2'>
          ...
          <div className='relative overflow-hidden'>
            ...
            >
              {images.map((src, index) => (
                <img key={index} src={src} alt={`Slide ${index + 1}`} className='w-full h-[250px] max-sm:h-[189px] flex-shrink-0' />
              ))}
            </div>
          </div>
        </div>
        ...
        <div className='md:col-start-4 md:col-span-3 lg:col-start-9 lg:col-end-12 2xl:pt-[14rem] max-sm:col-start-1 max-sm:col-span-2'>
          <img
            src="/images/About_title.svg"
            alt="Gadgets"
            className='absolute lg:top-[8.2rem] md:top-[4.2rem] grid md:w-[205px] max-sm:w-[180px] md:h-[25px] max-sm:top-[3rem]'
          />
          <p className='text-[#929292] grid absolute mt-8 lg:top-[9.5rem] md:top-[5.5rem] max-w-[332px] max-sm:max-w-[255px] max-sm:max-h-[176px] max-sm:top-[19rem] max-sm:col-start-1 max-sm:col-span-2'>KAT loco is a foot-based VR locomotion system that gives complete physical control over lower-body actions, allowing you to freely walk, run, and carry out just any other movement in virtual reality.
          </p>
          <div
            className='w-[236px] h-[48px] object-fit absolute cursor-pointer
                    lg:top-[20.5rem] max-sm:top-[33rem] md:top-[17rem] translate-x-[-15%] 
        ...
        <div className='md:col-start-1 md:col-span-4 lg:col-start-1 2xl:col-start-2 lg:col-end-6 2xl:col-end-6 relative 2xl:mt-[5rem] lg:mt-[12rem] md:mt-[7rem] max-sm:mt-[19rem] max-sm:col-start-1 max-sm:col-span-2'>
        ...
        <div className='lg:block md:hidden max-sm:hidden 2xl:col-start-7 lg:col-start-8 lg:col-span-6 relative ml-6 lg:mb-0 2xl:mt-0 lg:mt-[8rem]'>
          <img
        ...
        <div className='lg:hidden md:block md:col-start-5 md:col-span-2 relative ml-6 max-sm:hidden'>
          <img
