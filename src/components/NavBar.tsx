...
const NavBar = () => {
  ...
  return (
    <div className='flex justify-between items-center md:pt-6 lg:pt-14 pt-7 lg:pl-[110px] lg:pr-[110px] md:pr-[34px] md:pl-[34px] sm:pl-[34px] sm:pr-[34px] md:w-auto md:mx-0 sm:w-[320px] sm:mx-auto max-sm:w-[320px] max-sm:mx-auto max-sm:pl-[34px] max-sm:pr-[34px] z-20'>
