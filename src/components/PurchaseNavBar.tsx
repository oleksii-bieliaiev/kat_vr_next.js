  ...
  return (
    ...
    <>
      <div className='flex justify-between items-center md:pt-6 2xl:pt-14 lg:pt-14 pt-7 lg:pl-[110px] lg:pr-[110px] md:pr-[34px] md:pl-[34px] sm:pl-[34px] sm:pr-[34px] md:w-auto md:mx-0 sm:w-[320px] sm:mx-auto max-sm:w-[320px] max-sm:mx-auto max-sm:pl-[34px] max-sm:pr-[34px] z-20'>
        ...
        <div
          className={`items-center lg:block md:hidden sm:hidden max-sm:hidden ${
            isPurchaseOpen ? 'text-[#05C2DF]' : 'text-[#545454]'
          }`}
        >
        ...
        <div
          className={`items-center lg:block md:hidden sm:hidden max-sm:hidden ${
            isPayVisible ? 'text-[#05C2DF]' : 'text-[#545454]'
          }`}
        >
        ...
        <div
          className={`items-center lg:block md:hidden sm:hidden max-sm:hidden ${
            isOrderComplete ? 'text-[#05C2DF]' : 'text-[#545454]'
          }`}
        >
          <a className='relative cursor-pointer hover:text-[#05C2DF] hover:duration-300'>
            Order complete
      ...
      <div className='lg:hidden sm:flex max-sm:flex max-sm:flex-row justify-between pt-7 md:pr-[34px] md:pl-[34px] sm:pl-[34px] sm:pr-[34px] md:w-auto md:mx-0 sm:w-[320px] sm:mx-auto max-sm:w-[320px] max-sm:mx-auto max-sm:pl-[34px] max-sm:pr-[34px] z-20'>
        <a href='#about' className='relative cursor-pointer text-white text-sm hover:text-[#05C2DF] hover:duration-300'>
          Place Order
        </a>
        <a href='#tech' className='relative group cursor-pointer text-white text-sm hover:text-[#05C2DF] hover:duration-300'>
          Pay
        </a>
        <a href='#benefits' className='relative cursor-pointer text-white text-sm hover:text-[#05C2DF] hover:duration-300'>
          Order complete
        </a>
      </div>
    </>
