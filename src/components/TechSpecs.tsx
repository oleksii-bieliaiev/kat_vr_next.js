...
const TechSpecs = () => {
  ...
  return (
    <section id='tech' className='relative flex flex-col 2xl:min-h-[72vh] lg:min-h-[82vh] md:min-h-[120vh] max-sm:min-h-[65vh] bg-black lg:pl-[110px] lg:pr-[110px] lg:pt-[100px] lg:pb-[100px] md:pt-[80px] md:pb-[80px] md:pl-[32px] md:pr-[32px] max-sm:pl-[34px] max-sm:pr-[34px] max-sm:pt-[50px] max-sm:pb-[50px]'>
      <div className='grid lg:grid-cols-12 md:grid-cols-6 max-sm:grid-cols-2 justify-center relative'>
        <img
          src="/images/TechSpecs_big.svg"
          alt='TechSpecs'
          className='hidden lg:grid 2xl:col-start-3 2xl:col-end-12 lg:col-start-2 lg:col-end-12 2xl:w-[1175px] 2xl:h-[479px] lg:w-full lg:h-full'
        />
        <img
          src='/images/Title_TS.svg'
          alt='title'
          className='lg:hidden md:flex md:col-start-1 md:col-span-2 max-sm:col-start-1 max-sm:col-span-2 mb-[50px] max-sm:bg-contain md:w-[222px] md:h-[29px] '
        />
        <img
          src='/images/Techspecs_small.svg'
          alt='TechSpecs_small'
          className='lg:hidden md:flex md:col-start-2 md:col-span-4 max-sm:col-start-1 max-sm:col-span-2 md:w-[358px] md:h-[354px] max-sm:w-[214px] max-sm:h-[206px] relative text-center md:justify-center md:items-center mx-auto'
        />

        <div className={`lg:hidden md:flex absolute md:w-[62px] z-10 md:h-[62px] max-sm:h-[34px] max-sm:w-[34px] md:left-[32%] max-sm:left-[33%] md:mt-14 max-sm:mt-[4.5rem] md:object-cover max-sm:bg-cover cursor-pointer ${isInfoThirdVisible
              ? 'bg-[url(/images/Ellipse_minus.svg)]'
              : 'bg-[url(/images/Ellipse_plus.svg)]'
            }`}
          onClick={toggleInfoThird}>
        </div>
        <div className={`lg:hidden md:flex absolute md:w-[62px] z-10 md:h-[62px] max-sm:h-[34px] max-sm:w-[34px] md:left-[59%] max-sm:left-[65%] md:mt-56 max-sm:mt-[10rem] md:object-cover max-sm:bg-cover cursor-pointer ${isInfoSecondVisible
              ? 'bg-[url(/images/Ellipse_minus.svg)]'
              : 'bg-[url(/images/Ellipse_plus.svg)]'
            }`}
