...
const TechSpecs = () => {
  ...
  return (
    <section id='tech' className='relative flex flex-col 2xl:min-h-[72vh] lg:min-h-[82vh] md:min-h-[120vh] max-sm:h-[68vh] bg-black lg:pl-[110px] lg:pr-[110px] lg:pt-[100px] lg:pb-[100px] md:pt-[80px] md:pb-[80px] md:pl-[32px] md:pr-[32px] sm:pt-[50px] sm:pb-[50px] max-sm:pt-[50px] max-sm:pb-[50px]'>
