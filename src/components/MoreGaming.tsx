...
const MoreGaming = () => {
  return (
    <section id='faq' className='relative flex flex-col max-sm:min-h-[100vh] md:min-h-[160vh] lg:min-h-[90vh] 2xl:min-h-[75vh] bg-black lg:pr-[110px] lg:pl-[110px] md:pr-[34px] md:pl-[34px] max-sm:pl-[34px] max-sm:pr-[34px]'>
      ...
      <img
          ...
          alt="Gadgets"
          className='2xl:mt-[9.5rem] lg:mt-[6.5rem] md:mt-[4.5rem] max-sm:mt-[2rem] w-[368px] h-[44px] max-sm:w-[209px] max-sm:h-[25px] lg:col-start-5 lg:col-span-4 md:col-start-3 md:col-span-2 max-sm:col-start-1 max-sm:col-span-2'
        />
        <img
      ...
      <div className='grid lg:grid-cols-12 md:grid-cols-6 2xl:gap-8 gap-4 mt-[6%] max-sm:mt-[3%] 2xl:mb-[9.5rem] lg:mb-[6.5rem] md:mb-[6.5rem] sm:mb-[2rem] max-sm:mb-[2rem]'>
        ...
        <div className='lg:col-start-10 lg:col-span-3 md:col-start-4 md:col-span-3 flex flex-col max-sm:items-start md:items-center cursor-pointer transition-transform transform duration-300 hover:scale-105'>
          <img src="/images/pic_4.svg" alt="Block 4" className='block max-sm:hidden w-[84px] h-[84px] object-contain' />
