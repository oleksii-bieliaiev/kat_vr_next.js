...
const MoreGaming = () => {
  return (
    <section id='faq' className='relative z-10 flex flex-col max-sm:justify-center max-sm:h-[100vh] md:min-h-[160vh] lg:min-h-[90vh] 2xl:min-h-[75vh] bg-black lg:pr-[110px] lg:pl-[110px] md:pr-[34px] md:pl-[34px]'>
